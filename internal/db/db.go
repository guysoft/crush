...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.setSessionCurrentAgentStmt, err = db.PrepareContext(ctx, setSessionCurrentAgent); err != nil {
		return nil, fmt.Errorf("error preparing query SetSessionCurrentAgent: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.setSessionCurrentAgentStmt != nil {
		if cerr := q.setSessionCurrentAgentStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing setSessionCurrentAgentStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	setSessionCurrentAgentStmt           *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		setSessionCurrentAgentStmt:           q.setSessionCurrentAgentStmt,
